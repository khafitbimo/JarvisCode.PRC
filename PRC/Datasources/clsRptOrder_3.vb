...
Namespace DataSource
    ...
    Public Class clsRptOrder_3
        ...
        '==== ADD PTS 20130801
        Private mRekContactLine As String
        '=================
        ...
        Private mRekananPO_Telpon As String
        Private mRekananPO_Fax As String
        ...
        '============= ADD PTS 20130801 ===================
        Public Property rekcontactline() As String
            Get
                Return mRekContactLine
            End Get
            Set(ByVal value As String)
                mRekContactLine = value
                setAtributRekanan()
            End Set
        End Property
        '==================================================
        ...
        Private Sub setAtributRekanan()
            ...
            If mRekanan_id > 0 Then
                ...
                Try
                    ...
                    '====MODIFIED BY PTS 20130801==========
                    If mRekContactLine = "0" Or mRekContactLine = "" Or mRekContactLine Is Nothing Then
                        parCriteria.Value = String.Format(" rekanan_id = {0} ", mRekanan_id)
                        tblRekananPO = clsUtil.GetDataTable("pr_MstRekanan_po_Select", Me.DSN, parCriteria)
                    Else
                        parCriteria.Value = String.Format(" a.rekanan_id = {0} and b.rekanancontact_line = {1}", mRekanan_id, mRekContactLine)
                        tblRekananPO = clsUtil.GetDataTable("pr_MstRekanan_po_Select1", Me.DSN, parCriteria)
                    End If
                    '======================================
                    ...
                    If tblRekananPO.Rows.Count > 0 Then
                        ...
                        Me.mRekananPO_Telpon = tblRekananPO.Rows(0)("rekanan_telp").ToString.Trim
                        Me.mRekananPO_Fax = tblRekananPO.Rows(0)("rekanan_fax").ToString.Trim
                    End If
        ...
        Public Property rekananro_fax() As String
            ...
            End Set
        End Property
        Public Property rekananpo_telpon() As String
            Get
                Return mRekananPO_Telpon
            End Get
            Set(ByVal value As String)
                mRekananPO_Telpon = value
            End Set
        End Property

        Public Property rekananpo_fax() As String
            Get
                Return mRekananPO_Fax
            End Get
            Set(ByVal value As String)
                mRekananPO_Fax = value
            End Set
        End Property
