''
Public Class uiTrnAcquisitionOrder
    Private Const mUiName As String = "Acquisition Order"
...
#Region " Window Parameter "
    ...
    Private _ORDER_SOURCE As String = "AQ"  '[ML=Manual, PQ, MQ] 
    Private _ORDERTYPE_ID As String = "AO"  '[PO    , MO]
                    ...
                    With dlgRequest
                        ...
                        If .DialogResult = DialogResult.OK Then
                            ...
                            If count > 0 Then
                                ...
                                Me.tbl_RequestdetilSelect.DefaultView.RowFilter = String.Format(" requestdetil_ordered = {0}", True)
                                Me.DgvTrnRequestdetil.DataSource = Me.tbl_RequestdetilSelect.DefaultView
                                Me.DgvTrnRequestdetil.Columns("requestdetil_ordered").Visible = False
...
#Region "Attachment"
    Private Sub obj_addattachment_Click(sender As Object, e As EventArgs) Handles obj_addattachment.Click
        ...
        If Me.object_attach_dlg.ShowDialog = DialogResult.OK Then
            If New IO.FileInfo(Me.object_attach_dlg.FileName).Length > 5000000 Then ' jika file lebih besar dari 11000000 byte tidak boleh diattach
