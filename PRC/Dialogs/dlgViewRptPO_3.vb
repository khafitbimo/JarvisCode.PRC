Public Class dlgViewRptPO_3
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportH.ReportEmbeddedResource = "PRC.rptTrnPO_05.rdlc" '"PRC.rptTrnPO_04.rdlc"
    ...
    Private Function GenerateDataHeader() As ArrayList
        ...
        For i = 0 To Me.tbl_TrnOrder.Rows.Count - 1
            ...
            With objTrnPOPrintHeader
                ...
                '=====ADD PTS 20130801==
                .rekcontactline = clsUtil.IsDbNull(Me.tbl_TrnOrder.Rows(i).Item("order_othercost").ToString, "0") 'REkananContractLine dari master_rekanancontact
                '========================
                .request_id = Me.tbl_TrnOrder.Rows(i).Item("request_id").ToString
                ...
                ElseIf Mid(.order_id, 1, 2) = "AO" Then
                    Me.p_report_name = New Microsoft.Reporting.WinForms.ReportParameter("p_report_name", "ACQUISITION ORDER")
                End If
