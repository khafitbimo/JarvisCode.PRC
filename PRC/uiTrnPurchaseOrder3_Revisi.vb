...
Public Class uiTrnPurchaseOrder3_Revisi
    Private Const mUiName As String = "Purchase Order Revisi"
...
#Region " Window Parameter "
    ...
    Private _ORDER_SOURCE As String = "MQ"  '[ML=Manual, PQ, MQ] 
    Private _ORDERTYPE_ID As String = "MO"  '[PO    , MO]
...
#Region " Overrides "
    ...
    Public Overrides Function btnNew_Click() As Boolean
        ...
        End If
        Me.confirmNew()
        Me.uiTrnPurchaseOrder3_Revisi_NewData()
        Me.bgtAmount_value.Clear()
        Me.ReservedItem = False
        Me.uiTrnPurchaseOrder3_Revisi_GetOrderSource()
...
#Region " Layout & Init UI "
    ...
    Private Function InitLayoutUI() As Boolean
        ...
        If Me._FORMMODE = "VIEW" Then
            Me.uiTrnPurchaseOrder3_Revisi_SetViewOnly()
        End If
...
#Region " User Defined Function "
    Private Function uiTrnPurchaseOrder3_Revisi_NewData() As Boolean
        'new data
        ...
        Me.tbl_TrnOrder_Temp.Columns("order_setdate").DefaultValue = Now()
        uiTrnPurchaseOrder3_Revisi_CekChannel()
        ...
        End Try
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_GetOrderSource() As Boolean
                            ...
                            If Me.tbl_RequestdetilSelect.Rows.Count > 0 Then
                                For i = 0 To Me.tbl_RequestdetilSelect.Rows.Count - 1
                                    ...
                                    If Me.tbl_RequestdetilSelect.Rows(i).Item("item_id").ToString <> "" Then
                                        Me.uiTrnPurchaseOrder3_Revisi_SetItemDetil(i, i)
                                    Else
                                ...
                                For i = 0 To Me.DgvTrnRequestdetil.Rows.Count - 1
                                    ...
                                    Else
                                        ...
                                        If newitem Then
                                            ...
                                            Me.uiTrnPurchaseOrder3_Revisi_SetItemDetil(k, i)
        ...
        End Try
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SetItemDetil(ByVal rowidx_a As Integer, ByVal rowidx As Integer) As Boolean
        Try
        ...
        End Try
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Retrieve() As Boolean
        'retrieve data
        ...
        If Not Me.COMBO_ISFILLED Then
            Me.uiTrnPurchaseOrder3_Revisi_LoadDataCombo()
        End If

        Me.lblTotalRows.Visible = True
        Me.lblTotalRows.Text = Me.DgvTrnOrder.Rows.Count & " " & "Row(s)"

        'uiTrnPurchaseOrder3_Revisi_GetOrderCreator()
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Save() As Boolean
        'save data
        ...
        If tbl_TrnOrder_Temp_Changes IsNot Nothing _
            ...
            Try
                ...
                Try
                    If tbl_TrnRequestdetil_Changes IsNot Nothing Then
                        For i = 0 To Me.tbl_TrnRequestdetil.Rows.Count - 1
                            ...
                            End If
                        Next
                        success = Me.uiTrnPurchaseOrder3_Revisi_SaveRequestDetil(request_id, requestdetil_line, tbl_TrnRequestdetil_Changes, MasterDataState)
                        If Not success Then Throw New Exception("Error: Save RequestDetil Data at Me.uiTrnPurchaseOrder3_Revisi_SaveDetil(tbl_TrnRequestdetil_Changes)")
                ...
                If tbl_TrnOrder_Temp_Changes IsNot Nothing Then
                    Me.uiTrnPurchaseOrder3_Revisi_DetilCalculate(Me.DgvTrnOrderdetil, Me.TotalDetil, Me.TotalDetilPPH, Me.TotalDetilPPN, Me.TotalDetilDisc)
                    Me.uiTrnPurchaseOrder3_Revisi_TotalCalculate()

                    success = Me.uiTrnPurchaseOrder3_Revisi_SaveMaster(order_id, tbl_TrnOrder_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnPurchaseOrder3_Revisi_SaveMaster(tbl_TrnOrder_Temp_Changes)")
                    '-- Save Delivery Date --
                    ''Me.tbl_order_delivery_date = tbl_TrnOrder_Temp_Changes
                    'success = Me.uiTrnPurchaseOrder3_Revisi_SaveMasterDeliveryDate(order_id, tbl_orderdeliverydate_Temp_changes, MasterDataState)
                    ...
                    '-- Save to ERP --
                    success = Me.uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP(curr, order_id, tbl_TrnOrder_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP(tbl_TrnOrder_Temp_Changes)")

                    success = Me.uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP_TOP(order_id, tbl_TrnOrder_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP_TOP(tbl_TrnOrder_Temp_Changes)")
                    '-----------------
                    Me.tbl_TrnOrder_Temp.AcceptChanges()
                End If
                ...
                If tbl_TrnOrderdetil_Changes IsNot Nothing Then
                    ...
                    Next
                    Try
                        success = Me.uiTrnPurchaseOrder3_Revisi_SaveDetil(order_id, tbl_TrnOrderdetil_Changes, MasterDataState)
                        If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnPurchaseOrder3_Revisi_SaveDetil(tbl_TrnOrderdetil_Changes)")
                    Catch ex As Exception
                    End Try

                    ' -- Save detil to ERP --
                    success = Me.uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP_Order(order_id, Me.tbl_TrnOrderdetil, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnPurchaseOrder3_Revisi_SaveDetil(tbl_TrnOrderdetil_Changes)")
                    ' -----------------------
                ...
                If tbl_TrnOrderpaymreq_Changes IsNot Nothing Then
                    success = Me.uiTrnPurchaseOrder3_Revisi_SaveDetilPaymReq(order_id, tbl_TrnOrderpaymreq_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Payment Request Data at Me.uiTrnPurchaseOrder3_Revisi_SavePaymentreqreference(tbl_TrnPaymentreqreference_Changes)")
                ...
                If SHOW_SAVE_CONFIRMATION Then
                    ...
                    Me.uiTrnPurchaseOrder3_Revisi_OpenRowDetil(channel_id, order_id, dbConn)
                    Me.uiTrnPurchaseOrder3_Revisi_OpenRowPaymReq(channel_id, order_id, dbConn)
                    Me.uiTrnPurchaseOrder3_Revisi_OpenRowPurchaseReq(channel_id, order_id, dbConn)
                End If
            Catch ex As Exception
        ...
        Me.Cursor = Cursors.Arrow
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveMaster(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        ...
        Return True
    End Function
    'Private Function uiTrnPurchaseOrder3_Revisi_SaveMasterDeliveryDate(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    '    Dim dbCmdInsert As OleDb.OleDbCommand
    '    Dim dbCmdUpdate As OleDb.OleDbCommand
    '    Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP(ByRef curr As Object, ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Me.Cursor = Cursors.WaitCursor
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP_TOP(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Me.Cursor = Cursors.WaitCursor
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim ord_descr As String = ""
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveMaster_ERP_Order(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Me.Cursor = Cursors.WaitCursor
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveRequestDetil(ByRef request_id As Object, ByRef requestdetil_line As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveDetil(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveUse(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveDetilPaymReq(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_SaveDetilPurchaseReq(ByRef request_id As Object, ByRef requestdetil_line As Object, ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_PrintPreview() As Boolean
        'print data
        Dim i As Integer
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Print() As Boolean
        Dim i As Integer
        Dim row As DataGridViewRow
        Dim order_id As String
        Dim criteria As String = ""
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Delete() As Boolean
        Dim res As String = ""
        Dim order_id As Object = New Object
        ...
        If Me.DgvTrnOrder.CurrentRow IsNot Nothing Then
            ...
            If res = DialogResult.Yes Then
                'Me.uiTrnPurchaseOrder3_Revisi_DeleteRow(Me.DgvTrnOrder.CurrentRow.Index)
            End If
        End If
        RaiseEvent FormAfterDelete(order_id)
        Me.Cursor = Cursors.Arrow
    End Function
    'Private Function uiTrnPurchaseOrder3_Revisi_DeleteRow(ByVal rowIndex As Integer) As Boolean
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    '    Dim dbCmdDelete As OleDb.OleDbCommand
    '    Dim order_id As String
    ...
    '                Me.uiTrnPurchaseOrder3_Revisi_OpenRow(NewRowIndex)
    ...
    '            Else
    '                Me.tbl_TrnOrder.Rows.RemoveAt(rowIndex)
    '                Me.uiTrnPurchaseOrder3_Revisi_OpenRow(rowIndex)
    '            End If
    ...
    '    End Try
    'End Function
    Private Function uiTrnPurchaseOrder3_Revisi_OpenRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim order_id As String
        Dim channel_id As String
        Dim row As DataGridViewRow
        ...
        Try
            ...
            Try
                Me.uiTrnPurchaseOrder3_Revisi_OpenRowMaster(channel_id, order_id, dbConn)
                j += 1
            Catch ex As Exception
            ...
            Me.uiTrnPurchaseOrder3_Revisi_OpenRowPaymReq(channel_id, order_id, dbConn)
            Me.uiTrnPurchaseOrder3_Revisi_OpenRowPurchaseReq(channel_id, order_id, dbConn)
            Me.uiTrnPurchaseOrder3_RevisiOrderApproval_OpenRowDetil(channel_id, order_id, dbConn)
            Me.uiTrnPurchaseOrder3_RevisiOrderBPB_OpenRowDetil(channel_id, order_id, dbConn)
            Me.uiTrnPurchaseOrder3_RevisiOpenRow_DocCirc(channel_id, order_id, dbConn)
            Me.uiTrnPurchaseOrder3_RevisiOpenRow_InvReceipt(channel_id, order_id, dbConn)
            Me.uiTrnPurchaseOrder3_RevisiOpenRow_Advance(channel_id, order_id, dbConn)
            Me.obj_Budget_id.Enabled = False
            Me.cbo_Budget_name.Enabled = False
            ...
            End If
            Me.uiTrnPurchaseOrder3_Revisi_Lock()
            Me.IsiBudgetName()
            'Me._ORDER_SOURCE = "FromRequest"
        Catch ex As Exception
            MessageBox.Show(ex.Message, mUiName & ": uiTrnPurchaseOrder3_Revisi_OpenRow()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            dbConn.Close()
        End Try
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_OpenRowMaster(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_Revisi_OpenRowMaster()" & vbCrLf & ex.Message)
        End Try
        Me.tbl_order_delivery_date = Me.tbl_TrnOrder_Temp.Copy
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_OpenRowDetil(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_Revisi_OpenRowDetil()" & vbCrLf & ex.Message)
        End Try


    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_OpenRowPaymReq(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.DgvTrnOrderPaymReq.DataSource = Me.tbl_TrnOrderPaymReq
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_Revisi_OpenRowPaymReq()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_OpenRowPurchaseReq(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_Revisi_OpenRowPurchaseReq()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnPurchaseOrder3_RevisiOrderApproval_OpenRowDetil(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        Dim appby As String
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_RevisiOrderApproval_OpenRowDetil()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnPurchaseOrder3_RevisiOrderBPB_OpenRowDetil(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_RevisiOpenRow_DocCirc(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            'Me.dgvTrnOrderApproval.DataSource = Me.tbl_TrnOrderApproval
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_RevisiOpenRow_DocCirc()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnPurchaseOrder3_RevisiOpenRow_InvReceipt(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            'Me.dgvTrnOrderApproval.DataSource = Me.tbl_TrnOrderApproval
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_RevisiOpenRow_InvReceipt()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnPurchaseOrder3_RevisiOpenRow_Advance(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            'Me.dgvTrnOrderApproval.DataSource = Me.tbl_TrnOrderApproval
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnPurchaseOrder3_RevisiOpenRow_Advance()" & vbCrLf & ex.Message)
        End Try

    End Function


    Private Function uiTrnPurchaseOrder3_Revisi_First() As Boolean
        ...
        If iTab = 1 Then
            If Me.DATA_ISLOCKED Then
                move = True
            Else
                move = Me.uiTrnPurchaseOrder3_Revisi_ConfirmSaveBeforeMove(Message)
            End If
        Else
            move = True
        End If
        ...
        If move Then
            ...
            Me.uiTrnPurchaseOrder3_Revisi_RefreshPosition()
        End If
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Prev() As Boolean
        ...
        End If
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Next() As Boolean
        ...
        End If
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Last() As Boolean
        ...
        End If
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_RefreshPosition() As Boolean
        'refresh position
        Dim iTab As Integer = Me.FlatTabMain.SelectedIndex

        If iTab = 1 Then
            Me.uiTrnPurchaseOrder3_Revisi_OpenRow(Me.DgvTrnOrder.CurrentRow.Index)
            Me.uiTrnPurchaseOrder3_Revisi_GetOrderCreator()
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_GetOrderCreator() As Boolean
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_ConfirmSaveBeforeMove(ByVal Message As String) As Boolean
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_ConfirmSaveBeforeAddItem(ByVal Message As String) As Boolean
        'confirm saving data changes before move
        Dim tbl_TrnOrder_Temp_Changes As DataTable
        Dim tbl_TrnOrderdetil_Changes As DataTable
        Dim tbl_TrnOrderpaymreq_Changes As DataTable
        ...
        Return move
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_FormError() As Boolean
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_DetilCalculate(ByVal dgv As DataGridView, ByRef sumdetil As Decimal, ByRef sumPPH As Decimal, ByRef sumPPN As Decimal, ByRef sumDisc As Decimal) As Boolean
        Dim i As Integer
        ...
        Next
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_TotalCalculate() As Boolean
    ...
    End Function
#End Region
    Private Sub uiTrnPurchaseOrder3_Revisi_FormAfterOpenRow(ByRef id As Object) Handles Me.FormAfterOpenRow
        Me.uiTrnPurchaseOrder3_Revisi_DetilCalculate(Me.DgvTrnOrderdetil, Me.TotalDetil, Me.TotalDetilPPH, Me.TotalDetilPPN, Me.TotalDetilDisc)
        Me.uiTrnPurchaseOrder3_Revisi_TotalCalculate()
        ...
        Me.BindingContext(Me.tbl_TrnOrderdetil).EndCurrentEdit()
    End Sub
    Private Sub uiTrnPurchaseOrder3_Revisi_FormBeforeNew() Handles Me.FormBeforeNew
        ...
        End If
    End Sub
    Private Function uiTrnPurchaseOrder3_Revisi_LoadDataCombo() As Boolean
        Dim criteria As String = ""
        ...
        End Try
    End Function
    Private Sub uiTrnPurchaseOrder3_Revisi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.uiTrnPurchaseOrder3_Revisi_LoadSupportingData()
            If Not Me.COMBO_ISFILLED Then
                Me.uiTrnPurchaseOrder3_Revisi_LoadDataCombo()
            End If
    ...
    'End Sub
    Private Function uiTrnPurchaseOrder3_Revisi_SetViewOnly() As Boolean
        'NavigationButton
        Me.tbtnDel.Enabled = False
        Me.tbtnEdit.Enabled = False
    ...
    End Function
    Private Function uiTrnPurchaseOrder3_Revisi_Lock() As Boolean
    ...
    Private Sub btnAddItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddItem.Click
        ...
        Me.uiTrnPurchaseOrder3_Revisi_TotalCalculate()
    End Sub
    Private Sub uiTrnPurchaseOrder3_Revisi_CekChannel()
    ...
    Private Function ConfirmSaveAddItem(ByVal type As String) As Boolean
        ...
        If iTab = 1 Then
            If Me.DATA_ISLOCKED Then
                move = True
            Else
                move = Me.uiTrnPurchaseOrder3_Revisi_ConfirmSaveBeforeAddItem(Message)
            End If
        Else
            move = True
        End If
    ...
    'End Sub
    Private Sub uiTrnPurchaseOrder3_Revisi_Resize(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Resize
    ...
    End Sub
    Private Sub uiTrnPurchaseOrder3_Revisi_LoadSupportingData()
        Dim tbl_TrnOrder_Status As New DataTable
        ...
        If Me.DgvTrnOrder.Rows.Count > 0 Then
            For i = 0 To Me.DgvTrnOrder.SelectedRows.Count - 1
                ...
                Else
                    ...
                    End Try
                    uiTrnPurchaseOrder3_Revisi_Retrieve()
                End If
