Public Class clsUtil
    ...
    Public Shared Function ExecuteCommand(ByVal _sCommand As String, ByVal _sConn As String, ByVal _cmdType As System.Data.CommandType) As Boolean
        Dim oConn As System.Data.OleDb.OleDbConnection = New System.Data.OleDb.OleDbConnection(_sConn)
        Dim oCmd As System.Data.OleDb.OleDbCommand
        Dim cookie As Byte() = Nothing
        Try
            'oConn = New System.Data.OleDb.OleDbConnection(_sConn)
    ...
    Public Shared Function ServerDate(ByVal DSN As String) As Date
        ...
        Try
            ...
            cmd = New OleDb.OleDbCommand("SELECT GetDate()", dbConn)
    ...
    Public Shared Function skalar(ByVal sql As String, ByVal DSN As String) As Object
        Dim cookie As Byte() = Nothing
