...
Public Class clsPrintPO_3
    ...
    Dim p_rekananpo_name, p_rekananpo_alamat1, p_rekananpo_alamat2, p_rekananpo_alamat3, p_rekananpo_telp, p_rekananpo_fax As Microsoft.Reporting.WinForms.ReportParameter
    ...
    Public Sub Cetak()
        ...
        dtfiller.DataFillLimit(Me.tbl_TrnOrder, "pr_TrnOrder_Select3", Me.criteria, 10, Me.channel_id)
    ...
    Private Function GenerateReport() As Boolean
        ...
        Try
            ...
            objReportH.ReportEmbeddedResource = "PRC.rptTrnPO_04.rdlc"
            ...
            objReportH.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {Me.p_delivery_date})

            objReportH.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {Me.p_rekananpo_fax})
            objReportH.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {Me.p_rekananpo_telp})
            '==
    ...
    Private Function GenerateDataHeader() As ArrayList
        ...
        For i = 0 To Me.tbl_TrnOrder.Rows.Count - 1
            ...
            With objTrnPOPrintHeader
                ...
                'Me.p_order_setdate = New Microsoft.Reporting.WinForms.ReportParameter("p_order_setdate", v_order_date)
                ...
                Me.p_rekananpo_fax = New Microsoft.Reporting.WinForms.ReportParameter("p_rekananpo_fax", .rekananpo_fax)
                Me.p_rekananpo_telp = New Microsoft.Reporting.WinForms.ReportParameter("p_rekananpo_telp", .rekananpo_telpon)
            End With
