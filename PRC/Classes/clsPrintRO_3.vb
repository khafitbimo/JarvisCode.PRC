...
Public Class clsPrintRO_3
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportH.ReportEmbeddedResource = "PRC.rptTrnRO_04.rdlc"
    ...
    '    Dim image As Image = System.Drawing.Image.FromStream(m_streams(m_currentPageIndex))
    '    Try
