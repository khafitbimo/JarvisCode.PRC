Public Class dlgViewRptRO
    ...
    Private Sub dlgViewRptRO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportH.ReportEmbeddedResource = "PRC.rptTrnRO_01.rdlc"
        ...
        For i = 0 To Me.tbl_TrnRentalOrder.Rows.Count - 1
            ...
            With objTrnROPrintHeader
                ...
                .order_Total = Me.order_subtotal - .order_discount + .order_insurancecost _
                               + .order_transportationcost + .order_operatorcost + .order_othercost - .ro_PPH + .ro_PPN
    ...
    Private Sub GenerateDataDetail()
        ...
        Dim objRODetil As DataSource.clsRptOrderDetil
        ...
        For i = 0 To Me.tbl_TrnRentalOrderDetil.Rows.Count - 1
            ...
            objRODetil = New DataSource.clsRptOrderDetil(Me.DSN)
            With objRODetil
                ...
                .rodetil_rowtotalforeign_incldisc = clsUtil.IsDbNull(Me.tbl_TrnRentalOrderDetil.Rows(i).Item("rodetil_rowtotalforeign_incldisc"), 0)

                'objTrnROPrintHeader.Discount += .orderdetil_idr
                Me.order_subtotal += .rodetil_rowtotalforeign_incldisc
