Public Class dlgViewRptPO
    ...
    Dim p_rekananpo_name, p_rekananpo_alamat1, p_rekananpo_alamat2, p_rekananpo_alamat3, p_rekananpo_up, p_rekananpo_up_position As Microsoft.Reporting.WinForms.ReportParameter

    Dim po_pph, po_ppn, order_disc, orderdetil_disc As Decimal


    Private Sub dlgViewRptPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dtfiller As clsDataFiller = New clsDataFiller(Me.DSN)

        dtfiller.DataFillLimit(Me.tbl_TrnOrder, "pr_TrnOrder_Select", Me.criteria, 10)
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportH.ReportEmbeddedResource = "PRC.rptTrnPO_01.rdlc"
