...
#Region " Window Parameter "
    ...
    Private _CHANNEL As String = "NTV" 'clsConfig.globDefaultChannel
...
#Region " Layout & Init UI "
    ...
    Private Function BindingStart() As Boolean
        ...
        Try
            ...
            Me.dtp_Order_Dlvrdate.DataBindings.Add(New Binding("Text", Me.tbl_TrnOrder_Temp, "orderdelivery_date"))
...
#Region " User Defined Function "
                    ...
                    With dlgRequest
                        ...
                        If .DialogResult = DialogResult.OK Then
                            ...
                            With .dgvRequestList
                                ...
                                'Me.mtb_Order_settime.Text = clsUtil.IsDbNull(Format(.Item("request_useddt", reqIndex).Value, "HH:mm"), "")
                    ...
                    With dlgRequest
                        ...
                        If .DialogResult = DialogResult.OK Then
                            ...
                            If count > 0 Then
                                ...
                                Next
                                'tambahan 29 mar 2011 mba melly proc--------------------------------------------
                                ...
                                '.dgvRequestList.DataSource = tbl_RequestSelect
                                With tbl_RequestSelect
                                    ' clsUtil.IsDbNull(Me.tbl_RequestSelect.Rows(0).Item("orderdetil_rowtotalforeign_incldisc"), 0)

                                    Me.dtp_order_setdate.Value = clsUtil.IsDbNull(.Rows(0).Item("request_preparedt").ToString, Now)
                                    'Me.mtb_Order_settime.Text = clsUtil.IsDbNull(Format(.Rows(0).Item("request_useddt").ToString, "HH:mm"), "")
    ...
    Private Function uiTrnPurchaseOrder3_SetItemDetil(ByVal rowidx_a As Integer, ByVal rowidx As Integer) As Boolean
        Try
            ...
            'Me.tbl_TrnOrderdetil.Rows(rowidx_a).Item("o    rderdetil_discountforeign") = Math.Round(Me.DgvTrnRequestdetil.Rows(rowidx_a).Cells("requestdetil_discount").Value, 2, MidpointRounding.AwayFromZero)
            'Else
            ...
            'Me.tbl_TrnOrderdetil.Rows(rowidx_a).Item("orderdetil_rowtotalidr_incldisc") = (Me.DgvTrnRequestdetil.Rows(rowidx).Cells("requestdetil_foreignreal").Value - Math.Round(clsUtil.IsDbNull(Me.DgvTrnRequestdetil.Rows(rowidx_a).Cells("requestdetil_discount").Value, 0), MidpointRounding.AwayFromZero)) * Me.DgvTrnRequestdetil.Rows(rowidx).Cells("requestdetil_foreignrate").Value * Me.DgvTrnRequestdetil.Rows(rowidx).Cells("requestdetil_qty").Value
            ...
            'Me.tbl_TrnOrderdetil.Rows(rowidx_a).Item("orderdetil_rowtotalforeign_incldisc") = (Me.DgvTrnRequestdetil.Rows(rowidx).Cells("requestdetil_foreignreal").Value - Math.Round(clsUtil.IsDbNull(Me.DgvTrnRequestdetil.Rows(rowidx_a).Cells("requestdetil_discount").Value, 0), MidpointRounding.AwayFromZero)) * Me.DgvTrnRequestdetil.Rows(rowidx).Cells("requestdetil_qty").Value
    ...
    Private Function uiTrnPurchaseOrder3_Save() As Boolean
        ...
        If tbl_TrnOrder_Temp_Changes IsNot Nothing _
            ...
            Try
                ...
                Try
                    If tbl_TrnRequestdetil_Changes IsNot Nothing Then
                        For i = 0 To Me.tbl_TrnRequestdetil.Rows.Count - 1
                            ...
                            End If
                        Next
                        success = Me.uiTrnPurchaseOrder3_SaveRequestDetil(request_id, requestdetil_line, tbl_TrnRequestdetil_Changes, MasterDataState)
                ...
                If tbl_TrnOrder_Temp_Changes IsNot Nothing Then
                    ...
                    success = Me.uiTrnPurchaseOrder3_SaveMaster(order_id, tbl_TrnOrder_Temp_Changes, MasterDataState)
                    ...
                    '-- Save Delivery Date --
                    ''Me.tbl_order_delivery_date = tbl_TrnOrder_Temp_Changes
                    'success = Me.uiTrnPurchaseOrder3_SaveMasterDeliveryDate(order_id, tbl_orderdeliverydate_Temp_changes, MasterDataState)
                    'If Not success Then Throw New Exception("Error: Saving Master Data at Me.tbl_TrnOrder_Temp_Changes(tbl_TrnOrder_Temp_Changes)")
                    '-- Save to ERP --
                    'success = Me.uiTrnPurchaseOrder3_SaveMaster_ERP(curr, order_id, tbl_TrnOrder_Temp_Changes, MasterDataState)
                    'If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnPurchaseOrder3_SaveMaster_ERP(tbl_TrnOrder_Temp_Changes)")

                    'success = Me.uiTrnPurchaseOrder3_SaveMaster_ERP_TOP(order_id, tbl_TrnOrder_Temp_Changes, MasterDataState)
                    'If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnPurchaseOrder3_SaveMaster_ERP_TOP(tbl_TrnOrder_Temp_Changes)")
                    '-----------------
                    Me.tbl_TrnOrder_Temp.AcceptChanges()
                End If
                ...
                If tbl_TrnOrderdetil_Changes IsNot Nothing Then
                    ...
                    Next
                    Try
                        success = Me.uiTrnPurchaseOrder3_SaveDetil(order_id, tbl_TrnOrderdetil_Changes, MasterDataState)
                    ...
                    ' -- Save detil to ERP --
                    'success = Me.uiTrnPurchaseOrder3_SaveMaster_ERP_Order(order_id, Me.tbl_TrnOrderdetil, MasterDataState)
                    'If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnPurchaseOrder3_SaveDetil(tbl_TrnOrderdetil_Changes)")
                    ' -----------------------
                ...
                If tbl_TrnOrderpaymreq_Changes IsNot Nothing Then
                    success = Me.uiTrnPurchaseOrder3_SaveDetilPaymReq(order_id, tbl_TrnOrderpaymreq_Changes, MasterDataState)
                ...
                If tbl_TrnOrderdetileps_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnOrderdetileps.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnPurchaseOrder3_SaveDetilEps(order_id, tbl_TrnOrderdetileps_Changes, MasterDataState)
        ...
        Me.Cursor = Cursors.Arrow
    End Function
    Private Function uiTrnPurchaseOrder3_SaveMaster(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        ...
        Return True
    End Function
    'Private Function uiTrnPurchaseOrder3_SaveMasterDeliveryDate(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    '    Dim dbCmdInsert As OleDb.OleDbCommand
    '    Dim dbCmdUpdate As OleDb.OleDbCommand
    '    Dim dbDA As OleDb.OleDbDataAdapter
    ...
    '    ' Save data: transaksi_order_deliverydt
    '    dbCmdInsert = New OleDb.OleDbCommand("pr_TrnOrderDeliveryDate_Insert", dbConn)
    '    dbCmdInsert.CommandType = CommandType.StoredProcedure
    '    dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@order_id", Me.order_id_fordelivery))
    '    dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@delivery_date", System.Data.OleDb.OleDbType.DBTimeStamp, 4, "delivery_date"))


    '    dbCmdUpdate = New OleDb.OleDbCommand("pr_TrnOrderDeliveryDate_Update", dbConn)
    '    dbCmdUpdate.CommandType = CommandType.StoredProcedure
    '    dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@order_id", System.Data.OleDb.OleDbType.VarWChar, 30, "order_id"))
    '    dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@delivery_date", System.Data.OleDb.OleDbType.DBTimeStamp, 4, "delivery_date"))
    ...
    'Private Function uiTrnPurchaseOrder3_SaveMaster_ERP(ByRef curr As Object, ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
    '    Me.Cursor = Cursors.WaitCursor
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    ...
    '    Return True
    'End Function
    'Private Function uiTrnPurchaseOrder3_SaveMaster_ERP_TOP(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
    '    Me.Cursor = Cursors.WaitCursor
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    '    Dim ord_descr As String = ""
    ...
    '    Return True
    'End Function
    'Private Function uiTrnPurchaseOrder3_SaveMaster_ERP_Order(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
    '    Me.Cursor = Cursors.WaitCursor
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    '    Dim dbCmdInsert As OleDb.OleDbCommand
    '    Dim dbCmdUpdate As OleDb.OleDbCommand
    ...
    '                        dbCmdInsert.Parameters.Add("@amount", System.Data.OleDb.OleDbType.Decimal, 12).Value = objTbl.Rows(i).Item("orderdetil_foreign")
    '                    Else
    '                        dbCmdInsert.Parameters.Add("@amount", System.Data.OleDb.OleDbType.Decimal, 12).Value = 0
    '                    End If
    ...
    '                    If objTbl.Rows(i).Item("currency_id") = 1 Then
    '                        dbCmdUpdate.Parameters.Add("@amount", System.Data.OleDb.OleDbType.Decimal, 12).Value = objTbl.Rows(i).Item("orderdetil_foreign")
    '                    Else
    '                        dbCmdUpdate.Parameters.Add("@amount", System.Data.OleDb.OleDbType.Decimal, 12).Value = 0
    '                    End If
    ...
    '    Return True
    'End Function
    Private Function uiTrnPurchaseOrder3_SaveRequestDetil(ByRef request_id As Object, ByRef requestdetil_line As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_SaveDetil(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
    ...
    Private Function uiTrnPurchaseOrder3_SaveUse(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_SaveDetilPaymReq(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
    ...
    Private Function uiTrnPurchaseOrder3_SaveDetilPurchaseReq(ByRef request_id As Object, ByRef requestdetil_line As Object, ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        ...
        Return True
    End Function
    Private Function uiTrnPurchaseOrder3_SaveDetilEps(ByRef order_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
    ...
    Private Function uiTrnPurchaseOrder3_Delete() As Boolean
        ...
        Me.Cursor = Cursors.Arrow
    End Function
    'Private Function uiTrnPurchaseOrder3_DeleteRow(ByVal rowIndex As Integer) As Boolean
    '    Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    '    Dim dbCmdDelete As OleDb.OleDbCommand
    '    Dim order_id As String
    ...
    '                Me.uiTrnPurchaseOrder3_OpenRow(NewRowIndex)
    ...
    '            Else
    '                Me.tbl_TrnOrder.Rows.RemoveAt(rowIndex)
    '                Me.uiTrnPurchaseOrder3_OpenRow(rowIndex)
    '            End If
    ...
    Private Function uiTrnPurchaseOrder3_OpenRow(ByVal rowIndex As Integer) As Boolean
        ...
        Try
            ...
            'Me.uiTrnPurchaseOrder3OpenRow_DocCirc(channel_id, order_id, dbConn)
            'Me.uiTrnPurchaseOrder3OpenRow_InvReceipt(channel_id, order_id, dbConn)
            'Me.uiTrnPurchaseOrder3OpenRow_Advance(channel_id, order_id, dbConn)
            'Me.uiTrnPurchaseOrder3OpenRow_Episode(channel_id, order_id, dbConn)
            Me.obj_Budget_id.Enabled = False
            Me.cbo_Budget_name.Enabled = False
...
#End Region
        ...
        If Me.DgvTrnOrder.Rows.Count > 0 Then
            For i = 0 To Me.DgvTrnOrder.SelectedRows.Count - 1
                ...
                Else
                    ...
                    End Try
                    uiTrnPurchaseOrder3_Retrieve()
                End If

            Next
        End If
    End Sub
    'Private Sub dgvTrnOrderApproval_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs)
    '    Dim dgv As DataGridView = sender
    '    Dim objRow As System.Windows.Forms.DataGridViewRow = dgv.Rows(e.RowIndex)

    '    Try
    '        If objRow.Cells("order_approved").Value = 1 Then
    '            objRow.Cells("order_approvedname").Value = "Approved"
    '        Else
    '            objRow.Cells("order_approvedname").Value = "Dissaproved"
    ...
    'Private Sub DgvTrnOrderdetil_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnOrderdetil.CellContentClick

    'End Sub

    'Private Sub DgvTrnOrderdetil_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnOrderdetil.CellDoubleClick
    '    Dim dgv As DataGridView = sender

    '    MsgBox(dgv.Columns(e.ColumnIndex).ReadOnly)
    'End Sub
End Class
